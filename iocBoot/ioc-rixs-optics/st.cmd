...
epicsEnvSet("IPADDR",           "172.21.92.68")
epicsEnvSet("AMSID",            "172.21.92.68.1.1")
...
epicsEnvSet("MOTOR_NAME",      "PITCH")
epicsEnvSet("DESC",            "Main.M19 / SL1K2-Pitch")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:RIXS:OPTICS:")
epicsEnvSet("MOTOR_NAME",      "SL1K2-Vert")
epicsEnvSet("DESC",            "Main.M20 / SL1K2-Vert")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M21 / SL1K2-Roll")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M22 / SL1K2-Gap")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M23 / SL1K2-Yag")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
save_restoreSet_status_prefix( "PLC:RIXS:OPTICS:" )
